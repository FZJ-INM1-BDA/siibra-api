...
# url_tmpl='/v2_0/atlases/{}/spaces/{}/features{}?parcellation_id={}&region={}'
...
#     response = client.get('/v2_0/atlases/{}/spaces'.format(ATLAS_ID.replace('/', '%2F')))
...
#     response = client.get('/v2_0/atlases/{}/spaces/{}'.format(ATLAS_ID.replace('/', '%2F'), SPACE_ID))
...
#     response = client.get('/v2_0/atlases/{}/spaces/{}'.format(ATLAS_ID.replace('/', '%2F'), INVALID_SPACE_ID))
#     result_content = json.loads(response.content)
...
# #     response = client.get('/v2_0/atlases/{}/spaces/{}/parcellation_maps'.format(ATLAS_ID.replace('/', '%2F'), SPACE_ID))
# #     assert response.status_code == 200
