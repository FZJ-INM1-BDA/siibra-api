...
#     response = client.get(
#         '/v2_0/features/ReceptorDistribution?region=dummy',
...
#     response = client.get(
#         '/v2_0/features/WrongDistribution?region=dummy',
#         headers={"Authorization": "Bearer token"}
#     )
...
#     response = client.get(
#         '/v2_0/features/ConnectivityProfile?region=dummy',
#         headers={"Authorization": "Bearer token"}
#     )
...
#     response = client.get(
#         '/v2_0/features/ConnectivityMatrix?region=dummy',
#         headers={"Authorization": "Bearer token"}
#     )
#     assert response.status_code == 501
